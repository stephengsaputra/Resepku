//
//  EditRecipeIngredientsTableViewCell.swift
//  NanoChallenge01
//
...
class EditRecipeIngredientsTableViewCell: UITableViewCell {

    static let identifier = "EditRecipeIngredientsTableViewCell"
    ...
    internal lazy var recipeIngredientsTF: UITextView = {
    ...
    func configureUI() {
        ...
        contentView.addSubview(recipeIngredientsTF)
        recipeIngredientsTF.snp.makeConstraints { make in
